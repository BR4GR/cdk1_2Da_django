...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        df_europe = df[(df['lat'] >= EUROPE_SOUTH) & (df['lat'] <= EUROPE_NORTH) &
                       (df['lng'] >= EUROPE_WEST) & (df['lng'] <= EUROPE_EAST)]
        ...
        self.stdout.write(self.style.SUCCESS('Successfully loaded European cities into the database.'))